...
service Hbase {
  ...
  /**
   * Get the columns with the specified prefixes for the specified table and
   * row at the latest timestamp. Returns an empty list if the row does not
   * exist.
   *
   * @return TRowResult containing the row and map of columns to TCells
   */
  list<TRowResult> getRowWithMultipleColumnPrefixes(
    /** name of table */
    1:Text tableName,
    ...
    /**
     * the list of families of the keys you want
     * null or empty for all families
     */
    3:list<Text> families

    /**
     * the list of multiple column prefixes of the keys you want
     * null or empty for all columns
     */
    4:list<Text> columnPrefixes
  ) throws (1:IOError io)
   ...
   * @return TRowResult containing the row and map of columns to TCells
   */
  list<TRowResult> getRowWithMultipleColumnPrefixesTs(
    /** name of table */
    1:Text tableName,

    /** row key
     * empty for the first row
     * null or incorrect row name will throw an error
     */
    2:Text row,
  ...
  /**
   * delete assoc based on given flag
   */
  i64 taoAssocDelete(
    /** name of table */
    1:Text tableName,
  ...
  /**
   * get data with (id1, type, id2). Check vis flag
   */
  ...
  /**
   * get number of assocs with (id1, type)
   */
  i64 taoAssocCount(
    /** name of table */
    1:Text tableName,
  ...
  /**
   * Get a scanner on the current table starting at the row with specified
   * prefix and ending at last row in the table. Return the specified columns.
   * Only values with the specified timestamp are returned.
   *
   * @return scanner id to be used with other scanner procedures
   */
  ScannerID scannerOpenWithPrefixTs(
    /** name of table */
    1:Text tableName,
  ...
  /**
   * Open a scanner for a given column prefix.  That is all rows are
   * scanned and only those columns which match the specified column
  ...
  ScannerID scannerOpenWithColumnPrefix(
    /** name of table */
    1:Text tableName,

    /** the column prefix of the keys you want */
    2:Text ColumnPrefix,
  ) throws (1:IOError io)
  ...
  ScannerID scannerOpenWithColumnPrefixTs(
    /** name of table */
    1:Text tableName,
   ...
   * @return scanner id to be used with other scanner procedures
   */
  ScannerID scannerOpenWithStopAndColumnPrefix(
    /** name of table */
    1:Text tableName,
   ...
   * @return scanner id to be used with other scanner procedures
   */
  ScannerID scannerOpenWithStopAndColumnPrefixTs(
    /** name of table */
    1:Text tableName,
  ...
  /**
   * Open a scanner for the given column prefixes. That is all rows are
   * scanned and only those columns whose qualifiers match any of the specified
   * column prefixes and families match any of the specified family names
   * will be returned
   * No other columns will be returned.
   *
   * If an empty or null family name array is passed - it will scan
   * all the columns specified within the column prefixes array
   *
   * If an empty or null columnPrefixes array is passed - it will scan
   * all the columns within the specified family names
   *
   * @return scanner id to use with other scanner calls
   */

  ScannerID scannerOpenWithMultipleColumnPrefixes(
    /** name of table */
    1:Text tableName,

    /** the list of families of the keys you want */
    2:list<Text> families

    /** the list of multiple column prefixes of the keys you want */
    3:list<Text> columnPrefixes
  ) throws (1:IOError io)
  ...
  ScannerID scannerOpenWithMultipleColumnPrefixesTs(
    /** name of table */
    1:Text tableName,
    ...
    /**
   * Get a scanner on the current table starting and stopping at the
   * specified rows. Return the columns whose qualifiers match any of the
   * specified column prefixes and families match any of the specified family
   * names will be returned
   * No other columns will be returned.
   *
   * @return scanner id to be used with other scanner procedures
   */
  ScannerID scannerOpenWithStopAndMultipleColumnPrefixes(
    /** name of table */
    1:Text tableName,
    ...
    /** the list of families of the keys you want */
    4:list<Text> families

    /** the list of multiple column prefixes of the keys you want */
    5:list<Text> columnPrefixes
  ) throws (1:IOError io)
   ...
   * @return scanner id to be used with other scanner procedures
   */
  ScannerID scannerOpenWithStopAndMultipleColumnPrefixesTs(
    /** name of table */
    1:Text tableName,
